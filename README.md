...
[![Frontend](https://img.shields.io/badge/Frontend-GitHub%20Pages-222222?style=for-the-badge&logo=githubpages&logoColor=white)](https://pages.github.com/)
[![Backend](https://img.shields.io/badge/Backend-Wix%20Velo%20HTTP-0C6EFC?style=for-the-badge&logo=wix&logoColor=white)](https://www.wix.com/velo)
[![Payments](https://img.shields.io/badge/Payments-Razorpay%20Gateway-02042B?style=for-the-badge&logo=razorpay&logoColor=3395FF)](https://razorpay.com/)
...
### Key Highlights
- **No Hosting Cost**: Frontend is permanently served over HTTPS via GitHub Pages (with custom domain `donate.ritinjali.org`).
...
function getCorsHeaders() {
    return {
        'Access-Control-Allow-Origin': '*', // Or restrict to 'https://donate.ritinjali.org' in production
...
The frontend consists of lightweight Vanilla HTML, CSS, and JS with zero framework dependencies.
